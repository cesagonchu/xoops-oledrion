...
define('_AM_OLEDRION_URL_HLP1', 'Product URL 1 (optional)');
define('_AM_OLEDRION_URL_HLP2', 'Product URL 2 (optional)');
define('_AM_OLEDRION_URL_HLP3', 'Product URL 3 (optional)');
